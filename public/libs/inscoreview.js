...
var MidiSetup = /** @class */ (function () {
    ...
    MidiSetup.midiTest = function (status, data1, data2) {
        MidiSetup.midiClients.forEach(function (client) {
            client.midiEvent(status, data1, data2);
        });
    };
    MidiSetup.printMidiEvent = function (event) {
        var midiMsg = new Map();
    ...
    MidiSetup.removeListener = function (client) {
        var index = MidiSetup.midiClients.indexOf(client);
        if (index > -1) {
